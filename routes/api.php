...
use App\Http\Controllers\Exercicio9Controller;
...
Route::post('exercicio/quatro', [Exercicio4Controller::class, 'parOuImpar']);

Route::post('exercicio/cinco', [Exercicio5Controller::class, 'divisivel']);
...
Route::post('exercicio/nove', [Exercicio9Controller::class, 'divisivelPorUser']);
